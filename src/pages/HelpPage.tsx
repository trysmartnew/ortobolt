      ...
      <Card data-tour="tour-help-support" className="p-5">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <a href="https://github.com/trysmartnew/ortobolt/issues" target="_blank" rel="noopener noreferrer" aria-label="Abrir suporte da Vanguard Veterinary" title="Abrir central de suporte no GitHub" className="text-sm text-[#29a399] mt-2 font-mono hover:underline">Suporte Vanguard Veterinary</a>
          </div>
