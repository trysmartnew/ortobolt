# fix_tour_complete_v3.py
# Versão corrigida: usa strings UTF-8 ao invés de bytes para lidar com emojis
import sys
import re
...
old_customization_card = r'<Card\s+className="p-5 mb-4 border-l-4 border-l-\[#0056b3\]">'
...
old_gallery_pattern = r"gallery:\s*\[\s*\{\s*target:\s*'__welcome__',\s*title:\s*'🗂️\s+Galeria de Casos',\s*content:\s*'Seu acervo clínico\..*?placement:\s*'left',\s*highlight:\s*true\s*\},\s*\],"
